...
const Services = () => {
  const services = [
    ...
    },
    {
      ...
      features: ["Σχεδιασμός χώρου", "Τοποθέτηση ειδών", "πλήρη ανακαίνιση (με δικά μας συνεργεία καθώς και τους ελαιοχρωματισμούς)"]
    },
    {
      icon: <Thermometer className="h-8 w-8" />,
      title: "Θέρμανση",
      description: "Εγκατάσταση και συντήρηση συστημάτων θέρμανσης.",
      features: ["Καλοριφέρ", "Ενδοδαπέδια θέρμανση", "Λέβητες"]
    },
    {
